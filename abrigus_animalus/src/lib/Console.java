 ...
 *
 * Adicionei trim ao readString para resolver problema em Windows. (jfc)
 * 
 */
...
public class Console {  /**
   ...
   {  int ch;
      ...
      return r.trim(); // Para revolver problema em Windows. (jfc)
   }
   ...
   /**
    * Função de espera, até ser premido "Enter"
    * @return the input string (without the newline)
    */
